...
export default function Auth() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    const redirectTo = Capacitor.isNativePlatform()
      ? 'https://trjnpqwcvfgiwypjzbjn.supabase.co/auth/v1/callback'
          ...
          >
            ...
            >
              ...
              >
                ...
                {/* Google Sign-In — outside the card so scale/clip never hides it */}
                <div style={{ width: '100%', maxWidth: '480px', display: 'flex', flexDirection: 'column', gap: formGap, flexShrink: 0 }}>
                  <div style={orDividerStyle}>
                    <div style={{ flex: 1, height: '1px', background: 'rgba(255,255,255,0.15)' }} />
                    <span style={{ color: 'rgba(255,255,255,0.45)', fontSize: '12px', fontWeight: 500, whiteSpace: 'nowrap' }}>or</span>
                    <div style={{ flex: 1, height: '1px', background: 'rgba(255,255,255,0.15)' }} />
                  </div>
                  <button
                    type="button"
                  ...
                  >
                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M17.64 9.2c0-.637-.057-1.251-.164-1.84H9v3.481h4.844a4.14 4.14 0 0 1-1.796 2.716v2.259h2.908C16.658 14.252 17.64 11.9 17.64 9.2z" fill="#4285F4"/>
